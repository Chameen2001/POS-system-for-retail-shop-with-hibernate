        ...
        try {
            if(mainBO.placeOrder(orderDTO)){
                ...
                for (int i = 0; i < orderDTO.getOrderDetailDTOS().size(); i++) {
                    itemDetailJMS[i] = new ItemDetailJM(mainBO.getItem(orderDTO.getOrderDetailDTOS().get(i).getItemCode()).getDescription(),String.valueOf(orderDTO.getOrderDetailDTOS().get(i).getQuantity()),String.valueOf(orderDTO.getOrderDetailDTOS().get(i).getUnitPrice()),String.valueOf(orderDTO.getOrderDetailDTOS().get(i).getPrice()));
                }
